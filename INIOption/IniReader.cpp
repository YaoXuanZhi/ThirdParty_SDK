...
void CIniReader::ReadString(LPCTSTR szSection, LPCTSTR szKey, LPCTSTR szDefaultValue,TCHAR szDst[255])
{
	GetPrivateProfileString(szSection, szKey, szDefaultValue, szDst, 255, m_szFileName); 
}